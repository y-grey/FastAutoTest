...
public class HTMLReporter extends AbstractReporter
{
    ...
    private static final String PERFORMANCE_FILE = "performance.html";
                               ...
                               String outputDirectoryName)
    {
        ...
        try
        {
            ...
            createPerformance(suites, outputDirectory, !useFrames, onlyFailures);
    ...
    private void createPerformance(List<ISuite> suites,
                                File outputDirectory,
                                boolean isIndex,
                                boolean onlyFailures) throws Exception
    {
        ...
        VelocityContext context = createContext();
        context.put(DEVICES_KEY, deviceList);
        context.put(SUITES_KEY, suites);
        context.put(ONLY_FAILURES_KEY, onlyFailures);
        generateFile(new File(outputDirectory, isIndex ? INDEX_FILE : PERFORMANCE_FILE),
                PERFORMANCE_FILE + TEMPLATE_EXTENSION,
                context);
    }
