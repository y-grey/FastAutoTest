...
public abstract class AbstractReporter implements IReporter {
    ...
    static {
        ...
        try {
            resourceBundle = ResourceBundle.getBundle("org.uncommons.reportng.messages.reportng",
                    META.getLocale());
        } catch (Exception e) {
            if (AbstractReporter.class.getResource("org.uncommons.reportng.messages") == null
                    || AbstractReporter.class.getResource("org.uncommons.reportng.templates") == null) {
                try {
                    FileUtils.copyDirectory(new File("fastautotest/src/main/resources/org/uncommons/reportng/"), new File(AbstractReporter.class.getResource("").getPath()));
